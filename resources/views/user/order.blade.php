                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="{{asset('uploads/product/'.$item->product_detail->image)}}" />
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12">{{$item->product_detail->name}}</div>
                                    <div class="col-xs-12"><small>{{$item->qty}}<span>1</span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span></span>{{$item->amount}}</h6>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span></span><span>{{$item->total_amount}}</span></div>
                                </div>
                            </div>
                        </div>
